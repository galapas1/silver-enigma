...
func (b *FetchResponseBlock) decode(pd packetDecoder, version int16) (err error) {
	...
	if metricRegistry != nil {
		sizeMetric = getOrRegisterHistogram(
...
func (r *FetchResponse) getOrCreateBlock(
	topic string,
	partition int32,
) *FetchResponseBlock {
	if r.Blocks == nil {
...
func (r *FetchResponse) AddMessageWithTimestamp(
	topic string,
	partition int32,
	key, value Encoder,
	offset int64,
...
func (r *FetchResponse) AddRecordWithTimestamp(
	topic string,
	partition int32,
	key, value Encoder,
	offset int64,
	...
	rec := &Record{
		...
		Value:          vb,
		OffsetDelta:    offset,
		TimestampDelta: timestamp.Sub(batch.FirstTimestamp),
	}
	batch.addRecord(rec)
}
...
func (r *FetchResponse) AddRecordBatchWithTimestamp(
	topic string,
	partition int32,
	key, value Encoder,
	offset int64,
...
func (r *FetchResponse) AddControlRecordWithTimestamp(
	topic string,
	partition int32,
	offset int64,
	producerID int64,
	...
	rec := &Record{
		Key:            ByteEncoder(crKey.raw),
		Value:          ByteEncoder(crValue.raw),
		OffsetDelta:    0,
		TimestampDelta: timestamp.Sub(batch.FirstTimestamp),
	}
	batch.addRecord(rec)
...
func (r *FetchResponse) AddMessage(
	topic string,
	partition int32,
	key, value Encoder,
	offset int64,
...
func (r *FetchResponse) AddRecord(
	topic string,
	partition int32,
	key, value Encoder,
	offset int64,
...
func (r *FetchResponse) AddRecordBatch(
	topic string,
	partition int32,
	key, value Encoder,
	offset int64,
...
func (r *FetchResponse) AddControlRecord(
	topic string,
	partition int32,
	offset int64,
	producerID int64,
	...
	r.AddControlRecordWithTimestamp(
		topic,
		partition,
		offset,
		producerID,
...
func (r *FetchResponse) SetLastOffsetDelta(
	topic string,
	partition int32,
	offset int32,
) {
...
func (r *FetchResponse) SetLastStableOffset(
	topic string,
	partition int32,
	offset int64,
) {
