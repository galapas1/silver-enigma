...
func (r *ListPartitionReassignmentsResponse) AddBlock(
	topic string,
	partition int32,
	replicas, addingReplicas, removingReplicas []int32,
) {
	...
	partitions[partition] = &PartitionReplicaReassignmentsStatus{
		Replicas:         replicas,
...
func (r *ListPartitionReassignmentsResponse) decode(
	pd packetDecoder,
	version int16,
) (err error) {
	r.Version = version
	...
	for i := 0; i < numTopics; i++ {
		...
		r.TopicStatus[topic] = make(
			map[int32]*PartitionReplicaReassignmentsStatus,
