...
func (m *MockListGroupsResponse) AddGroup(
...
func (mmr *MockMetadataResponse) SetError(
	topic string,
	kerror KError,
...
func (mmr *MockMetadataResponse) SetLeader(
	topic string,
	partition, brokerID int32,
) *MockMetadataResponse {
...
func (mmr *MockMetadataResponse) SetBroker(
	addr string,
	brokerID int32,
) *MockMetadataResponse {
...
func (mor *MockOffsetResponse) SetOffset(
	topic string,
	partition int32,
	time, offset int64,
) *MockOffsetResponse {
...
func (mor *MockOffsetResponse) getOffset(
	topic string,
	partition int32,
	time int64,
) int64 {
...
func (mfr *MockFetchResponse) SetHighWaterMark(
	topic string,
	partition int32,
	offset int64,
) *MockFetchResponse {
...
func (mfr *MockFetchResponse) getMessage(
	topic string,
	partition int32,
	offset int64,
) *mockMessage {
...
func (mr *MockConsumerMetadataResponse) SetCoordinator(
	group string,
	broker *MockBroker,
) *MockConsumerMetadataResponse {
	mr.coordinators[group] = broker
	return mr
}

func (mr *MockConsumerMetadataResponse) SetError(
	group string,
	kerror KError,
) *MockConsumerMetadataResponse {
...
func (mr *MockConsumerMetadataResponse) For(
...
func (mr *MockProduceResponse) SetError(
	topic string,
	partition int32,
	kerror KError,
) *MockProduceResponse {
...
func (mr *MockCreatePartitionsResponse) For(
	reqBody versionedDecoder,
) encoderWithHeader {
...
func NewMockAlterPartitionReassignmentsResponse(
	t TestReporter,
) *MockAlterPartitionReassignmentsResponse {
	return &MockAlterPartitionReassignmentsResponse{t: t}
}

func (mr *MockAlterPartitionReassignmentsResponse) For(
	reqBody versionedDecoder,
) encoderWithHeader {
...
func NewMockListPartitionReassignmentsResponse(
	t TestReporter,
) *MockListPartitionReassignmentsResponse {
	return &MockListPartitionReassignmentsResponse{t: t}
}

func (mr *MockListPartitionReassignmentsResponse) For(
	reqBody versionedDecoder,
) encoderWithHeader {
...
func NewMockDescribeConfigsResponseWithErrorCode(
	t TestReporter,
) *MockDescribeConfigsResponseWithErrorCode {
	return &MockDescribeConfigsResponseWithErrorCode{t: t}
}

func (mr *MockDescribeConfigsResponseWithErrorCode) For(
	reqBody versionedDecoder,
) encoderWithHeader {
	req := reqBody.(*DescribeConfigsRequest)
	res := &DescribeConfigsResponse{
...
func NewMockAlterConfigsResponseWithErrorCode(
	t TestReporter,
) *MockAlterConfigsResponseWithErrorCode {
	return &MockAlterConfigsResponseWithErrorCode{t: t}
}

func (mr *MockAlterConfigsResponseWithErrorCode) For(
	reqBody versionedDecoder,
) encoderWithHeader {
	req := reqBody.(*AlterConfigsRequest)
	res := &AlterConfigsResponse{Version: req.version()}
...
func NewMockIncrementalAlterConfigsResponse(
	t TestReporter,
) *MockIncrementalAlterConfigsResponse {
	return &MockIncrementalAlterConfigsResponse{t: t}
}

func (mr *MockIncrementalAlterConfigsResponse) For(
	reqBody versionedDecoder,
) encoderWithHeader {
...
func NewMockIncrementalAlterConfigsResponseWithErrorCode(
	t TestReporter,
) *MockIncrementalAlterConfigsResponseWithErrorCode {
	return &MockIncrementalAlterConfigsResponseWithErrorCode{t: t}
}

func (mr *MockIncrementalAlterConfigsResponseWithErrorCode) For(
	reqBody versionedDecoder,
) encoderWithHeader {
	req := reqBody.(*IncrementalAlterConfigsRequest)
	res := &IncrementalAlterConfigsResponse{Version: req.version()}
...
func (mr *MockCreateAclsResponse) For(reqBody versionedDecoder) encoderWithHeader {
	...
	for range req.AclCreations {
		res.AclCreationResponses = append(
			res.AclCreationResponses,
			&AclCreationResponse{Err: ErrNoError},
		)
	}
	return res
}
...
func (mr *MockCreateAclsResponseError) For(reqBody versionedDecoder) encoderWithHeader {
	...
	for range req.AclCreations {
		res.AclCreationResponses = append(
			res.AclCreationResponses,
			&AclCreationResponse{Err: ErrInvalidRequest},
		)
	}
	return res
}
...
func (msar *MockSaslAuthenticateResponse) For(
	reqBody versionedDecoder,
) encoderWithHeader {
...
func (msar *MockSaslAuthenticateResponse) SetError(
	kerror KError,
...
func (msar *MockSaslAuthenticateResponse) SetAuthBytes(
	saslAuthBytes []byte,
) *MockSaslAuthenticateResponse {
...
func (msar *MockSaslAuthenticateResponse) SetSessionLifetimeMs(
	sessionLifetimeMs int64,
) *MockSaslAuthenticateResponse {
...
func (mshr *MockSaslHandshakeResponse) SetError(
	kerror KError,
...
func (mr *MockDeleteAclsResponse) For(reqBody versionedDecoder) encoderWithHeader {
	...
	for range req.Filters {
		...
		response.MatchingAcls = append(
			response.MatchingAcls,
			&MatchingAcl{Err: ErrNoError},
		)
...
func (m *MockJoinGroupResponse) SetMember(
	id string,
...
func (m *MockSyncGroupResponse) SetMemberAssignment(
...
func (m *MockApiVersionsResponse) SetApiKeys(
	apiKeys []ApiVersionsResponseKey,
