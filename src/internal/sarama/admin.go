...
type ClusterAdmin interface {
	...
	ListPartitionReassignments(
		topics string,
		partitions []int32,
	) (topicStatus map[string]map[int32]*PartitionReplicaReassignmentsStatus, err error)
	...
	DescribeLogDirs(
		brokers []int32,
	) (map[int32][]DescribeLogDirsResponseDirMetadata, error)
	...
	// Delete SCRAM users
	DeleteUserScramCredentials(
		delete []AlterUserScramCredentialsDelete,
	) ([]*AlterUserScramCredentialsResult, error)

	// Upsert SCRAM users
	UpsertUserScramCredentials(
	...
	DescribeClientQuotas(
		...
		strict bool,
	) ([]DescribeClientQuotasEntry, error)
...
func (ca *clusterAdmin) retryOnError(
...
func (ca *clusterAdmin) CreateTopic(
	topic string,
	detail *TopicDetail,
	validateOnly bool,
) error {
...
func (ca *clusterAdmin) DescribeTopics(
	topics []string,
...
func (ca *clusterAdmin) CreatePartitions(
	topic string,
	count int32,
	assignment [][]int32,
	validateOnly bool,
...
func (ca *clusterAdmin) AlterPartitionReassignments(
	topic string,
	assignment [][]int32,
) error {
	if topic == "" {
...
func (ca *clusterAdmin) ListPartitionReassignments(
	topic string,
	partitions []int32,
) (topicStatus map[string]map[int32]*PartitionReplicaReassignmentsStatus, err error) {
	if topic == "" {
...
func (ca *clusterAdmin) DeleteRecords(
	topic string,
...
func (ca *clusterAdmin) AlterConfig(
	resourceType ConfigResourceType,
	name string,
	entries map[string]*string,
	validateOnly bool,
...
func (ca *clusterAdmin) IncrementalAlterConfig(
	resourceType ConfigResourceType,
	name string,
	entries map[string]IncrementalAlterConfigsEntry,
	validateOnly bool,
...
func (ca *clusterAdmin) DeleteACL(
	filter AclFilter,
	validateOnly bool,
) ([]MatchingAcl, error) {
...
func (ca *clusterAdmin) DescribeConsumerGroups(
	groups []string,
) (result []*GroupDescription, err error) {
...
func (ca *clusterAdmin) ListConsumerGroupOffsets(
	group string,
	topicPartitions map[string][]int32,
) (*OffsetFetchResponse, error) {
...
func (ca *clusterAdmin) DeleteConsumerGroupOffset(
	group string,
	topic string,
	partition int32,
) error {
...
func (ca *clusterAdmin) DescribeLogDirs(
	brokerIds []int32,
) (allLogDirs map[int32][]DescribeLogDirsResponseDirMetadata, err error) {
	...
	logDirsMaps := make(
		chan map[int32][]DescribeLogDirsResponseDirMetadata,
		len(brokerIds),
	)
...
func (ca *clusterAdmin) DescribeUserScramCredentials(
	users []string,
) ([]*DescribeUserScramCredentialsResult, error) {
	req := &DescribeUserScramCredentialsRequest{}
	for _, u := range users {
		req.DescribeUsers = append(
			req.DescribeUsers,
			DescribeUserScramCredentialsRequestUser{
				Name: u,
			},
		)
	}
...
func (ca *clusterAdmin) UpsertUserScramCredentials(
	upsert []AlterUserScramCredentialsUpsert,
) ([]*AlterUserScramCredentialsResult, error) {
...
func (ca *clusterAdmin) DeleteUserScramCredentials(
	delete []AlterUserScramCredentialsDelete,
) ([]*AlterUserScramCredentialsResult, error) {
...
func (ca *clusterAdmin) AlterUserScramCredentials(
	u []AlterUserScramCredentialsUpsert,
	d []AlterUserScramCredentialsDelete,
) ([]*AlterUserScramCredentialsResult, error) {
...
func (ca *clusterAdmin) DescribeClientQuotas(
	components []QuotaFilterComponent,
	strict bool,
) ([]DescribeClientQuotasEntry, error) {
...
func (ca *clusterAdmin) AlterClientQuotas(
	entity []QuotaEntityComponent,
	op ClientQuotasOp,
	validateOnly bool,
) error {
...
func (ca *clusterAdmin) RemoveMemberFromConsumerGroup(
	groupId string,
	groupInstanceIds []string,
) (*LeaveGroupResponse, error) {
	if !ca.conf.Version.IsAtLeast(V2_4_0_0) {
		return nil, ConfigurationError(
			"Removing members from a consumer group headers requires Kafka version of at least v2.4.0",
		)
	}
