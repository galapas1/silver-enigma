...
func (r *OffsetCommitRequest) encode(pe packetEncoder) error {
	if r.Version < 0 || r.Version > 7 {
		return PacketEncodingError{
			"invalid or unsupported OffsetCommitRequest version field",
		}
	}
...
func (r *OffsetCommitRequest) AddBlock(
	topic string,
	partitionID int32,
	offset int64,
	timestamp int64,
...
func (r *OffsetCommitRequest) AddBlockWithLeaderEpoch(
	topic string,
	partitionID int32,
	offset int64,
	leaderEpoch int32,
...
func (r *OffsetCommitRequest) Offset(
	topic string,
	partitionID int32,
) (int64, string, error) {
